...
public class JwtRequestFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		// Check ROLE_ANONYMOUS
		boolean isROLE_ANONYMOUS = false;
		...
		if (SecurityContextHolder.getContext().getAuthentication() != null
			...
			if (authorities.contains(new SimpleGrantedAuthority("ROLE_ANONYMOUS"))) {
				isROLE_ANONYMOUS = true;
			}
		}

		if (username != null && (SecurityContextHolder.getContext().getAuthentication() == null || isROLE_ANONYMOUS)) {
